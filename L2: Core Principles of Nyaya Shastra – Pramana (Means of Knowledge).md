...
#### 2. **Introduction to Pramana**
   ...
   - Nyaya identifies **four types of pramanas**:
     ...
     4. **Verbal Testimony (Shabda)**【5:5†source】.
...
#### 3. **Pratyaksha (Perception)**
   ...
   - Nyaya divides perception into two sub-categories:
     ...
     2. **Determinate Perception (Savikalpaka Pratyaksha)**:
        ...
        - E.g., recognizing a distant object as "a cow"【5:5†source】.
   - **Characteristics of Perception**:
     - Must be **non-erroneous** (as opposed to hallucinations).
     - Should be **determinable**, where the sensory impression becomes clear.
     - Arises from the direct contact of sense organs with objects【5:5†source】.
...
#### 4. **Anumana (Inference)**
   ...
   - Nyaya categorizes inference into three types:
     ...
     3. **Commonly Observed (Samanyato Drishta Anumana)**:
        ...
        - E.g., seeing a horned animal and inferring that it has a tail【5:5†source】.
   - **Process of Inference**:
     - Nyaya outlines the **five-membered syllogism (Panchavayava Nyaya)** as the structure of a logical argument:
       ...
       5. **Nigamana (Conclusion)**: The final conclusion drawn from the inference【5:5†source】.
...
#### 5. **Upamana (Comparison)**
   ...
   - **Relevance**:
     - It is often used to bridge gaps in understanding new or unfamiliar concepts by relating them to familiar entities【5:5†source】.
...
#### 6. **Shabda (Verbal Testimony)**
   ...
   - **Types of Verbal Testimony**:
     ...
     2. **Alaukika (Scriptural)**: Knowledge derived from sacred texts and authoritative religious figures.
        - E.g., accepting the statements in the Vedas regarding rituals and duties【5:5†source】.
   - **Conditions for Acceptance**:
     - The source must be knowledgeable and trustworthy.
     - The statement should not contradict perception or inference【5:5†source】.
...
#### 7. **Interrelations Among Pramanas**
   ...
   - Nyaya emphasizes that pramanas are **not mutually exclusive** but function as complementary paths to achieving correct knowledge【5:5†source】.
...
#### 8. **Epistemological Significance**
   ...
   - Nyaya's approach to knowledge is **empirical**, giving priority to direct observation while integrating reasoning, analogy, and testimony【5:5†source】.
...
#### 9. **Nyaya vs. Other Philosophical Schools**
   ...
   - Nyaya's inclusion of four pramanas allows for a **broader and more holistic approach** to knowledge acquisition【5:5†source】.
...
#### Suggested Readings for Students
   ...
   - Comparative readings from **Vaisheshika Sutras** and **Mimamsa Sutras** for contrasting views on pramanas【5:5†source】.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ3NzExNzgwOF19
-->