...
#### 2. **Introduction to Prameya**
   ...
   - Prameya is crucial for understanding the **ontological framework** of Nyaya philosophy, as it reveals the components of reality【5:5†source】.
...
#### 3. **The Twelve Prameyas (Objects of Knowledge)**
   ...
   - These prameyas together represent the **entire domain of knowledge** and are the objects that an individual must understand correctly to attain liberation (moksha)【5:5†source】.
...
##### 4.1 **Atman (Soul)**
   ...
   - Nyaya argues for the soul’s existence based on experiences of **memory, cognition, and continuity of identity**【5:5†source】.
...
##### 4.2 **Sharira (Body)**
   ...
   - Role:
     ...
     - It enables the operation of senses and activities that are necessary for survival and knowledge acquisition【5:5†source】.
...
##### 4.3 **Indriya (Senses)**
   ...
   - Relation to Elements:
     - Each sense corresponds to one of the **five elements** (earth, water, fire, air, ether)【5:5†source】.
...
##### 4.4 **Artha (Objects of Senses)**
   ...
   - Categories:
     ...
     - These objects are qualities of the **five great elements** (Pancha Mahabhuta), making them central to perceptual knowledge【5:5†source】.
...
##### 4.5 **Buddhi (Intellect)**
   ...
   - Role:
     ...
     - It processes information provided by the senses and the mind, leading to conceptual understanding【5:5†source】.
...
##### 4.6 **Manas (Mind)**
   ...
   - Nyaya distinguishes the mind from the soul, treating it as an intermediary between the senses and the intellect【5:5†source】.
...
##### 4.7 **Pravritti (Activity)**
   ...
   - It plays a key role in the **causal chain** that influences karma, affecting rebirth and experiences in future lives【5:5†source】.
...
##### 4.8 **Dosha (Fault)**
   ...
   - These faults are considered the primary causes of **suffering and bondage**, keeping the soul trapped in the cycle of rebirth【5:5†source】.
...
##### 4.9 **Pretyabhava (Rebirth/Transmigration)**
   ...
   - The doctrine of rebirth is supported by evidence from **memory of past lives, dreams, and intuitive experiences**【5:5†source】.

##### 4.10 **Phala (Fruit/Result)**
   - **Definition**: Phala denotes the **results or outcomes** of actions, whether good (punya) or bad (papa).
   - It includes immediate and long-term consequences that manifest in the current or future lives of the soul【5:5†source】.
...
##### 4.11 **Duhkha (Pain)**
   ...
   - Pain can be physical, mental, or existential, encompassing all forms of discomfort【5:5†source】.
...
##### 4.12 **Apavarga (Release/Liberation)**
   ...
   - Liberation involves the **elimination of faults (doshas)** and cessation of karma, allowing the soul to exist in a state of pure consciousness【5:5†source】.
...
#### 5. **Philosophical Significance of Prameya**
   ...
   - Understanding prameya helps to **contextualize** the process of liberation, as it involves discerning the true nature of existence through correct knowledge【5:5†source】.
...
#### 6. **Nyaya’s Unique Ontology**
   ...
   - Prameya serves as both the **goal of inquiry** and the **pathway to moksha**, making it central to Nyaya’s epistemological framework【5:5†source】.
...
#### Suggested Readings for Students
   ...
   - Comparative readings from **Vaisheshika Sutras** to understand similarities and differences in their treatment of prameya【5:5†source】.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3Mjk1MDEzOV19
-->